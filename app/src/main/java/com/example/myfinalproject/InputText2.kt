...
const val EXTRA_MESSAGEE = "com.example.myfinalproject.MESSAGE"

class InputText2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.input_text_2)
    ...
    fun sendMessage(view: View) {
        ...
        val intent = Intent(this, DisplayMessageActivity2::class.java).apply {
            putExtra(EXTRA_MESSAGEE, message)
