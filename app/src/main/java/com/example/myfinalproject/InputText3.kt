...
const val EXTRA_MESSAGEEE = "com.example.myfinalproject.MESSAGE"

class InputText3 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.input_text_3)
    ...
    fun sendMessage(view: View) {
        ...
        val intent = Intent(this, DisplayMessageActivity3::class.java).apply {
            putExtra(EXTRA_MESSAGEEE, message)
